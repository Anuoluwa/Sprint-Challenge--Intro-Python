...
c = [human.name for human in humans if ord(human.name[0]) in tuple(range(ord('C'), ord('H')))]
print(c)
...
f = [(human.name, human.age) for human in humans if human.age in human.age >= 27 and human.age <= 32]
print(f)
